...
/** `max` was added in pi 0.75; keep the extension source compatible with older type packages. */
export type ConfiguredThinkingLevel = ModelThinkingLevel | "max";
...
const THINKING_LEVEL_VALUES: readonly ConfiguredThinkingLevel[] = [
	"off",
	"minimal",
	"low",
	"medium",
...
function isThinkingLevel(value: unknown): value is ConfiguredThinkingLevel {
